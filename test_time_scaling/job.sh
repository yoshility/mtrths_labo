...
uv run python point_biserial_prepare.py --llm qwen --prm qwen800 --data gsm8k
uv run python point_biserial_prepare.py --llm qwen --prm qwen800 --data mmlu
uv run python point_biserial_prepare.py --llm llama --prm qwenPRM --data gsm8k
uv run python point_biserial_prepare.py --llm llama --prm qwenPRM --data mmlu
uv run python point_biserial_prepare.py --llm llama --prm qwen800 --data gsm8k
uv run python point_biserial_prepare.py --llm llama --prm qwen800 --data mmlu